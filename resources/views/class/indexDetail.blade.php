...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            Kategori : {{ ucfirst($kategori_materi->kategori_kursus) }} | Materi :
            {{ ucfirst($kategori_materi->nama_materi) }}
        </h4>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('admin::class-material-detail', ['id' => $item->id]) }}">
                                                    @csrf
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('admin::delete-class-material-detail', ['id' => $item->id, 'id_materi' => $id]) }}">
                                                    @csrf
        ...
        <div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="{{ route('admin::add-materi-video') }}" method="POST" role="form"
                        id="form-add-course-material-detail" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="modal-body">
                            <input type="hidden" id="id-kategori-kursus" name="id_kategori_kursus"
                                value="{{ $id }}">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col mb-4 mb-2">
                                    <div class="form-floating form-floating-outline">
                                        <input type="number" id="orderSeq" class="form-control" name="order_seq"
                                            min="1">
                            ...
                            <div class="row">
                                <div class="col mb-4 mb-2">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" id="deskripsi_image" class="form-control"
                                            name="deskripsi_image">
                                        <label for="deskripsiImage">Deskripsi Image</label>
                                    </div>
                                </div>
                            </div>
                        </div>
