...
@section('styles')
    <style>
        ...
        .scroll-item {
            min-width: 100px; /* Adjust according to your content */
            padding: 10px;
            margin: 0 5px;
        ...
        ::-webkit-scrollbar-thumb {
            ...
            min-height: 2px; /* Set the minimum height of the scrollbar handle */
        ...
        body::-webkit-scrollbar-thumb {
            ...
            min-height: 2px; /* Set the height of the scrollbar handle */
            border-radius: 10px; /* Set the border radius of the scrollbar handle */
        }
        ...
        /* Track */
        body {
            scrollbar-color: #888 #f0f0f0; /* Color of the scrollbar track and handle */
        }
        ...
        .image {
            ...
            box-shadow: 0 4px 8px rgba(147, 145, 145, 0.1); /* Add shadow effect */
        }
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="image-container">
                            <img class="image" src="{{ $costume_type_list[0]->image }}" alt="Your Image" id="image-first">
                        </div>
                        <div class="scroll-container">
                            <div class="scroll-content">
                                @foreach ($costume_type_list as $item)
                                    <a href="#" id="{{ $item->id }}" onclick="onAClick('{{ $item->id }}')" data-items="{{ json_encode($item) }}">
                        ...
                        <div class="cart">
                            ...
                            <div class="cart-item p-2">
                                <div class="row">
                                    ...
                                    <input type="hidden" name="id_costume_type" id="id-costume-type" value="{{ $costume_type_list[0]->id_costume_type }}">
                                    <input type="hidden" name="id_costume_type_detail" id="id-costume-type-detail" value="{{ $costume_type_list[0]->id }}">
                                    <input type="hidden" name="id_user" id="id-user" value="{{ session('id') }}">
                                    <div class="item-details p-3">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="quantity">
                                                    <button class="quantity-button" onclick="decreaseQty(this)">-</button>
                                                    <input type="text" class="quantity-input" value="1">
                                                    <button class="quantity-button" onclick="increaseQty(this)">+</button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="col-md-6"><p>Stock: <span id="stock">{{ $costume_type_list[0]->stock }}</span></p></div>
                                            </div>
                                        </div>
                                        <div class="row pt-2">
                                            ...
                                            <div class="col-md-6">
                                                <p>Rp. 
                                                    <span id="harga">{{ number_format($costume_type_list[0]->harga, 0, ',', '.') }}</span> / 
                                                    <span id="time">{{ $costume_type_list[0]->jangka_waktu_sewa }}</span> hr
                                                </p>
                                            </div>
                                        </div>
                                        <div class="row pt-2">
                                            <div class="col-md-6"><h4>Total</h4></div>
                                            <div class="col-md-6"><p>Rp. <span id="total-harga">{{ number_format($costume_type_list[0]->harga, 0, ',', '.') }}</span></p></div>
                                        </div>
                                    </div>
                                    <div class="p-3">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            Hallo , Apakah anda Sudah yakin akan menyewa ?
                        </p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary ms-auto me-auto" id="ya">Ya</button>
                    </div>
                </div>
            </div>
        </div>
