<nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar" style="background-color: rgba(255,255,255,.9) !important;  box-shadow: 0px 4px 8px -4px rgba(58,53,65,.42) !important; padding: 0 1.25rem !important;">
    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <div class="navbar-nav align-items-center">
            <div class="nav-item navbar-search-wrapper mb-0">
                <a class="nav-item nav-link search-toggler fw-normal px-0">
                ...
                <li>
                    <a class="dropdown-item pb-2 mb-1" href="">
                        <div class="d-flex align-items-center">
                            ...
                            <h6 class="mb-0">{{ session('email_admin') }}</h6>
