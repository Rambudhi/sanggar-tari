<nav id="navbar" class="navbar">
    <ul>
        ...
        <li><a class="nav-link {{ Route::currentRouteName() == 'list-costume-rental' ? 'active' : '' }}" href="{{ route('list-costume-rental') }}">Penyewaan Kostum</a></li>
        <li><a class="nav-link {{ Route::currentRouteName() == 'list-return-costume-rental' ? 'active' : '' }}" href="{{ route('list-return-costume-rental') }}">Pengembalian Kostum</a></li>
