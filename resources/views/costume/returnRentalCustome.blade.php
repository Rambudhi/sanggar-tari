                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary"
                                        onclick="print('{{ $item->bukti_pembayaran }}')"> Show BP </button>
                                </td>
                                <td>
                                    <div class="d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
                                            <li>
                                                <a class="dropdown-item" onclick="onLiClick('{{ json_encode($item) }}')"
                                                    data-items="">
        ...
        <div class="modal fade" id="basicModalEdit" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="{{ route('admin::edit-return-rental-costume') }}" method="POST" role="form"
                        id="form-edit-return-rental-customer" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col mb-4 mt-2">
                                    <div class="form-floating form-floating-outline">
                                        <select class="form-select animation-dropdown me-2 w-100" id="status"
                                            name="status">
